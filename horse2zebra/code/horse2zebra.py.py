...
def save_models(step, g_model_AtoB, g_model_BtoA):
    ...
    filename1 = 'hor2zeb_g_model_AtoB_%06d.h5' % (step+1)
    g_model_AtoB.save(filename1)
    # save the second generator model
    filename2 = 'hor2zeb_g_model_BtoA_%06d.h5' % (step+1)
...
path = '/home/umni2/a/umnilab/users/mdebnat/Course Project/ECE 50024/Course Project/horse2zebra/'
